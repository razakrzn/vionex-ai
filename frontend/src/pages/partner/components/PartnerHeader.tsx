...
export const PartnerHeader = ({ onLogout }: PartnerHeaderProps) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white dark:glass border-b border-glass-border shadow-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            onClick={() => {
              ...
              // Set a flag in sessionStorage to allow navigation to home
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="md:hidden py-4 border-t border-glass-border animate-slide-up relative z-[9999] px-4">
